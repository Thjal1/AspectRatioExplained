...
public class ScreenLoad extends AbstractGameScreen {
    ...
    private static final String TAG = com.thortech.aspectratioexplained.Screens.ScreenLoad.class.getName();
    ...
    public ScreenLoad(AspectRatioExplained _game) {
        super(_game);
    ...
    public void render(float delta) {
        ...
        if ((Gdx.input.isTouched() || (timePast - timeStart) > timeShown)) {
            game.setScreen(AspectRatioExplained.screenMenu);
            dispose();
        }
    }
    public void create(){
