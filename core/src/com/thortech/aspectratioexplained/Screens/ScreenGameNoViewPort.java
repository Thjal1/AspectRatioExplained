 ...
 *
 */
public class ScreenGameNoViewPort extends AbstractGameScreen {

    private static final String TAG = ScreenGameNoViewPort.class.getName();
    ...
    public ScreenGameNoViewPort(AspectRatioExplained _game) {
	    super(_game);
    ...
    public void resize(int width, int height) {
        ...
        //cameraGame.position.set(Settings.PHYSICALWIDTH / 2, Settings.PHYSICALHEIGHT / 2, 0);
    }
