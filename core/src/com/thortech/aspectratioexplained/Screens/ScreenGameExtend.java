 ...
 *
 */
public class ScreenGameExtend extends AbstractGameScreen {
    ...
    private Board toFarToLeft = new Board(game, "LowerLeft.jpg");

    private OrthographicCamera cameraGame;      //For the game play

    private Viewport viewPort;

    public ScreenGameExtend(AspectRatioExplained _game) {
        super(_game);
        ...
        viewPort = new ExtendViewport(cameraGame.viewportWidth, cameraGame.viewportHeight, cameraGame);
        //viewPort.apply(true);
    ...
    public void placeActors()
    {
        ...
        backgroundBoard.changePos(new Vector3(0,0,0), false);
        ...
        toFarToLeft.changePos(new Vector3(-toFarToLeft.getSize().x, 0,0), false);
    }
