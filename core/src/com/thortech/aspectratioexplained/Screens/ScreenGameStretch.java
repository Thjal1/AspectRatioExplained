 ...
 *
 */
public class ScreenGameStretch extends AbstractGameScreen {
    ...
    public ScreenGameStretch(AspectRatioExplained _game) {
        super(_game);
        ...
        viewPort = new StretchViewport(cameraGame.viewportWidth, cameraGame.viewportHeight, cameraGame);
        viewPort.apply(true);
