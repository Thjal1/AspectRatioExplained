 ...
 *
 */
public class ScreenGameScale extends AbstractGameScreen {
    ...
    public ScreenGameScale(AspectRatioExplained _game) {
        super(_game);
        ...
        viewPort = new ScalingViewport(Scaling.none, cameraGame.viewportWidth, cameraGame.viewportHeight, cameraGame);
        viewPort.apply(true);
