...
public class Settings {
    ...
    private static final String preFile = "thortech_aspectratioexplained_settings.pre";
    ...
    public static float PHYSICALWIDTH = 10.0f;    //Size of the physical world widthin meters, the stage of the game
    public static float PHYSICALHEIGHT = 10.0f;   //Size of the physical world height - calculated in the constructor
    public static float PHYSICALSCALE;            //Scale ratio from screen size to physical world - calculated in the constructor

    //Make it a singleton
    private Settings(){
        //PHYSICALHEIGHT = PHYSICALWIDTH * (screenHeightPixels / screenWidthPixels);
    ...
    public static void resizeScreenPixels(int width, int height) {
    ...
    public static void setScreenHeightPixels(int screenHeightPixels) { Settings.screenHeightPixels = screenHeightPixels; }

    public static int getScreenWidthPixels() {
        return screenWidthPixels;
    }

    public static void setScreenWidthPixels(int screenWidthPixels) {
        Settings.screenWidthPixels = screenWidthPixels;
    }
